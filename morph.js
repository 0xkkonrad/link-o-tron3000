 ...
 */
 ...
 var asciis = [
  ...
  [
    "  ***************************************",
    "  *       I can stash your crypto.      *",
    "  *      You'll get a secret link       *",
    "  * and anyone can pick it up, anytime. *",
    "  *****∨********************************  ",
    "       ʕ⁎̯͡⁎ʔ༄                             ",
  ],
...
var element = document.querySelector('.squirrel');
AsciiMorph(element, { x: 20, y: 12 });
